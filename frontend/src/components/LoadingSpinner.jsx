function LoadingSpinner({ className = '' }) {
  return (
    <svg
      // 1. We add the animate-spin class here to make it rotate
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_4_309"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_4_309"
            result="shape"
          />
        </filter>
      </defs>
